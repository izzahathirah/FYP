...
<head>
	...
	<title>Student Comfirmation</title>
...
$uid=$_SESSION['login'];
				...
				if($rs)
				{ ?>
			<h3 style="color: red" align="center">Comfirmation section already booked</h3>
			<div align="center">
...
<input type="text"  name="id" id="id" class="form-control"  onChange="getSeater(this.value);" required> 
...
<div class="form-group">
<label class="col-sm-2 control-label">No-Bilik</label>
<div class="col-sm-4">
<input type="text" name="roomno" id="roomno"  class="form-control" onBlur="checkAvailability()" readonly="true">
<span id="room-availability-status" style="font-size:12px;"></span>
</div>



<label class="col-sm-1 control-label">Key Tag</label>
<div class="col-sm-3">
<input type="text" name="keytag" id="keytag"  class="form-control"  readonly="true">
...
<div class="col-sm-8">
<input type="text" name="meja" id="meja"  class="form-control" readonly="true">
</div>
</div>

<div class="form-group">
<label class="col-sm-2 control-label">Almari</label>
<div class="col-sm-8">
<input type="text" name="almari" id="almari"  class="form-control" readonly="true">
</div>
</div>

<div class="form-group">
<label class="col-sm-2 control-label">Katil</label>
<div class="col-sm-8">
<input type="text" name="katil" id="katil"  class="form-control" readonly="true">
</div>
</div>

<div class="form-group">
<label class="col-sm-2 control-label">Kerusi</label>
<div class="col-sm-8">
<input type="text" name="kerusi" id="kerusi"  class="form-control" readonly="true">
</div>
</div>
...
<option value="">Select Latest Semester</option>
...
<div class="form-group">
<label class="col-sm-2 control-label">Registration No(Matric Card) : </label>
<div class="col-sm-8">
