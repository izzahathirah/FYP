...
<body>
	 <div class="login-page bk-img" id="dvImage" style="height:100%; width: 100%" >
</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3" style="margin-top:4%">
						<h1 class="text-center text-bold text-light mt-1x well row bk-brand">Kamsis Management System<br>Admin Login</h1>
