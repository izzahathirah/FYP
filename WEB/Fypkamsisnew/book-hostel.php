...
<div class="col-sm-2">
<input type="text" name="blok" id="blok" value="<?php echo $row->blok;?>"  class="form-control"  readonly="true">

</div>
<label class="col-sm-1 control-label">Level</label>
<div class="col-sm-2">
<input type="text" name="aras" id="aras" value="<?php echo $row->aras;?>"  class="form-control"  readonly="true">
