...
$query="update  userregistration set firstName=?,lastName=?,gender=?,contactNo=?,updationDate=? where id=?";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('sssssi',$fname,$lname,$gender,$contactno,$udate,$aid);
$stmt->execute();
