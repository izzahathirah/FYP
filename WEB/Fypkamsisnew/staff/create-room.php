...
$kerusi=$_POST['kerusi'];
$roomno=$_POST['roomno'];
$sql="SELECT roomno FROM facilities where roomno=?";
...
{
$query="insert into  facilities (meja,katil,almari,kerusi,roomno) values(?,?,?,?,?)";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('sssss',$meja,$katil,$almari,$kerusi,$roomno);
$stmt->execute();
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Add a Room Information </h2>
...
<div class="col-sm-8">
<input type="text" class="form-control" name="roomno" id="roomno" value="" required="required">
</div>
</div>
<div class="form-group">
