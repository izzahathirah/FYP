						...
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-primary">
									...
									<div id="show_user_data" class="panel-body">
...
<input type="text"  name="room" id="room" class="form-control"  onChange="getSeater(this.value);" required> 
...
<div class="col-sm-4">
<input type="text" name="rooms" id="rooms"  class="form-control" onBlur="checkAvailability()" readonly="true">
